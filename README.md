...
- **[Month-End Close](skills/month-end-close/SKILL.md)** — Run a clean, fast month-end close with a controlled checklist.
- **[Financial Statement Builder](skills/financial-statement-builder/SKILL.md)** — Build and interpret the three core financial statements and explain how they interconnect.
- **[Budget vs. Actual Variance Analysis](skills/budget-vs-actual/SKILL.md)** — Produce a budget-vs-actual variance analysis that explains the why behind each gap, not just the numbers.
